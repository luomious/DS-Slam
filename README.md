# DS-SLAM: Dynamic Scene Semantic SLAM
...
|--------|------|------|
| M0 | 环境预检与项目初始化 | 已完成 |
| M1 | ORB-SLAM3 编译运行 | 进行中 |
| M2 | 轻量化语义分割网络 | 未开始 |
| M3 | ONNX 部署与 C++ 接口 | 未开始 |
| M4 | 动态特征剔除与几何校验 | 未开始 |
| M5 | 静态稠密建图 | 未开始 |
| M6 | Web 可视化系统 | 未开始 |
| M7 | 系统集成与测试 | 未开始 |
...
|------|------|
| 系统 | Windows 11 |
| C++ 工具链 | MSYS2 MinGW-w64 |
| CMake | 3.20+，通过 MSYS2 pacman 安装 |
| GCC / Make | MinGW-w64 gcc、mingw32-make |
| Python | 3.9 - 3.13 |
| CUDA | 12.x - 13.x，可用于后续语义分割加速 |
| Git | 最新稳定版 |
