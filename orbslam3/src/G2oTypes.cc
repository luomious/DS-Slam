...
*
* NOTE: Vertex and Edge implementations have been split into separate files
* (G2oTypesVertex.cc, G2oTypesEdge.cc, G2oTypesInertial.cc) to reduce
* object file size and fix Windows PE/COFF relocation issues.
*/
